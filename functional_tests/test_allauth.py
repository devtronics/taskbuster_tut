...
from selenium.webdiver.common.by import By
from selenium.wedriver.support.ui iport WebDriverWait
...
class TestGoogleLogin(StaticLiveServerTestCase):
    ...
    def get_button_by_id(self, namespace):
        return self.browser.wait.until(EC.element_to_be_clickable(
            (By.ID, element_id)))
    
    def get_full_url(self, namesapce):
